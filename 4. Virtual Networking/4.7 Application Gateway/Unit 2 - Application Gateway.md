...
Can route traffic to: Azure VMs, VM Scale Sets, Azure App Service, On-premises servers
...
-------
### AZ-104 Exam Tips
- Application Gateway = Layer 7 / HTTPS
...
HTTP/HTTPS + URL/path/host routing → Application Gateway

Load can be used for like TCP database connections 