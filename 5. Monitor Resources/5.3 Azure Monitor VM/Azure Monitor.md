...
- **Boot Diagnostics:** Captures serial console text logs and VM screen snapshots at startup to diagnose unbootable VMs (e.g., BSOD, kernel panic, corrupted boot-loader).
...
## 5. Metrics Explorer & Data Visualisation
