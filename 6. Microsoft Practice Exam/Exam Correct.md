...
- ~~Configure a user-defined route.**This answer is correct.**~~
...
~~Select only one answer.~~
~~an application security group **This answer is correct.**~~
~~a service tag~~
...
~~Versioning **This answer is correct.**~~
...
~~a copy element **This answer is correct.**~~
~~the API version~~
